/**
 * @file api/index.js
 * @description Vercel Serverless Function handler for Cake on Wheels REST API.
 * Provides free-of-cost backend API hosting under the same Vercel deployment domain.
 */
